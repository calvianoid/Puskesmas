                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <a class="au-btn au-btn-icon au-btn--blue" href="<?php echo base_url('user/tambah_user');?>">
                     ...
                     <center>
                            ...
                            {
                                echo "<tr align='center'><td>".$hasil->id_user."</td>";
                                echo "<td>".$hasil->nama_user."</td>"; 
                                echo "<td>".$hasil->username."</td>"; 
                                echo "<td>".$hasil->id_user."</td>"; 
                                echo "<td><a href='".base_url()."user/ubah_user/$hasil->id_user'><button class='btn btn-success'><i class='fa fa-magic'></i></button></a>";
                                echo "<a href='".base_url()."user/hapus_user/$hasil->id_user'><button class='btn btn-danger'><i class='fa fa-eraser'></i></button></a></td></tr>";
                            }
                            ?>
                        </table>
                        </div>

                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <a class="au-btn au-btn-icon au-btn--blue" href="<?php echo base_url('dokter/tambah_dokter');?>">
										...
										<li class="nav-item dropdown">
											<a class="nav-link dropdown-toggle au-btn au-btn-icon au-btn--blue" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-file-text"></i>Laporan</a>
									    		<div class="dropdown-menu">
													<a class="dropdown-item" href="<?php echo base_url('dokter/pdf');?>">Export PDF</a>
													<a class="dropdown-item" href="<?php echo base_url('dokter/export_excel');?>">Export EXCEL</a>
												</div>
                                        </li>
								    </ul>
                                </div>
                     ...
                     <center>
                            ...
                            {
                                echo "<tr align='center'><td>".$hasil->kode_dokter."</td>";
                                echo "<td>".$hasil->nama_dokter."</td>"; 
                                echo "<td>".$hasil->jenis_kelamin."</td>";
                                echo "<td>".$hasil->nomor_induk_dokter."</td>";
                                echo "<td>".$hasil->tempat_lahir."</td>"; 
                                echo "<td>".$hasil->tgl_lahir."</td>";
                                echo "<td>".$hasil->alamat."</td>";
                                echo "<td>".$hasil->id_poli."</td>";           
                                echo "<td><a href='".base_url()."dokter/ubah_dokter/$hasil->kode_dokter'><button class='btn btn-success'><i class='fa fa-magic'></i></button></a>";
                                echo "<a href='".base_url()."dokter/hapus_dokter/$hasil->kode_dokter'><button class='btn btn-danger'><i class='fa fa-eraser'></i></button></a></td></tr>";
                            }
                            ?>
                        </table>
                        </div>

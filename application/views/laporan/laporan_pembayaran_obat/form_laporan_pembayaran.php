...
<head>
    ...
    <!-- Title Page-->
    <title>LAPORAN PEMBAYARAN OBAT</title>
                    ...
                    <div class="container">
                        <div class="panel panel-default">
                            <div class="panel-body"><hr><br><br><hr>
                                <h2><i class='zmdi zmdi-file-text'></i> Laporan Pembayaran Obat</h2>
                                <hr>
                                <?php
                                $attribute = array('id' => 'FormLaporan');
                                echo form_open('laporan_pembayaran/pembayaran_obat', $attribute); ?>
                                <div class="row">
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <a class="btn btn-danger btn-lg active" href="<?php echo base_url('pembayaran/list_pembayaran');?>">
                                                        </i>Kembali</a>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan_pembayaran/pembayaran_obat'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

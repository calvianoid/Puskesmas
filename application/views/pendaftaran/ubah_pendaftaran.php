            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <center>
                        ...
                        <h1>UBAH DATA PENDATARAN</h1></br>
                            <td colspan="1">
                            <form action = "<?php echo base_url('pendaftaran/proses_ubah_pendaftaran')?>" method="post" class="well form-horizontal">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">KODE ANTRIAN</label>
                                        <div class="col-md-8 inputGroupContainer">
                                        <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="kode_antrian" name="kode_antrian" placeholder="Kode Antrian" class="form-control" required="true" value="<?= $baris[0]->kode_antrian?>" readonly="" type="text"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">TANGGAL PENDAFTARAN</label>
                                        <div class="col-md-8 inputGroupContainer">
                                        <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="tanggal_pendaftaran" name="tanggal_pendaftaran" placeholder="Tanggal Pendaftaran" class="form-control" required="true" value="<?= $baris[0]->tanggal_pendaftaran?>" type="date"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="nama_poli" id="nama_poli" class="form-control">
                                                <option value="<?= $baris[0]->nama_poli?>"><?= $baris[0]->nama_poli?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="nama_dokter" id="nama_dokter" class="form-control">
                                                <option value="<?= $baris[0]->nama_dokter?>"><?= $baris[0]->nama_dokter?></option>

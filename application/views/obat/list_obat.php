                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <a class="au-btn au-btn-icon au-btn--blue" href="<?php echo base_url('obat/tambah_obat');?>">
										...
										<li class="nav-item dropdown">
											<a class="nav-link dropdown-toggle au-btn au-btn-icon au-btn--blue" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-file-text"></i>Laporan</a>
									    		<div class="dropdown-menu">
													<a class="dropdown-item" href="<?php echo base_url('obat/pdf');?>">Export PDF</a>
													<a class="dropdown-item" href="<?php echo base_url('obat/export_excel');?>">Export EXCEL</a>
												</div>
                                        </li>
								    </ul>
                                </div>
                     ...
                     <center>
                            ...
                            {
                                echo "<tr align='center'><td>".$hasil->kode_obat."</td>";
                                echo "<td>".$hasil->nama_obat."</td>"; 
                                echo "<td>".$hasil->jenis_obat."</td>";
                                echo "<td>".$hasil->dosis_aturan_obat."</td>";
                                echo "<td>".$hasil->satuan."</td>";
                                echo "<td>Rp. ".$hasil->harga_obat."</td>";   
                                echo "<td><a href='".base_url()."obat/ubah_obat/$hasil->kode_obat'><button class='btn btn-success'><i class='fa fa-magic'></i></button></a>";
                                echo "<a href='".base_url()."obat/hapus_obat/$hasil->kode_obat'><button class='btn btn-danger'><i class='fa fa-eraser'></i></button></a></td></tr>";
                            }
                            ?>
                        </table>
                        </div>

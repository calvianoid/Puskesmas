                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <a class="au-btn au-btn-icon au-btn--blue" href="<?php echo base_url('poli/tambah_poli');?>">
                     ...
                     <center>
                            ...
                            {
                                echo "<tr align='center'><td>".$hasil->nama_poli."</td>";
                                echo "<td>".$hasil->ruang_poli."</td>";  
                                echo "<td><a href='".base_url()."poli/ubah_poli/$hasil->id_poli'><button class='btn btn-success'><i class='fa fa-magic'></i></button></a>";
                                echo "<a href='".base_url()."poli/hapus_poli/$hasil->id_poli'><button class='btn btn-danger'><i class='fa fa-eraser'></i></button></a></td></tr>";
                            }
                            ?>
                        </table>
                        </div>
